...
const BookingConsultation = () => {
  ...
  const getDoctorsDetails = () => {
    fetch(DATA_URL)
      ...
      .catch((err) => {
        console.log("Error when calling API, using local doctors instead:", err);
        setDoctors(LOCAL_DOCTORS);
      });
  };

  // 🔎 Fonksyon rechèch (menm lojik ak InstantConsultation.js)
  ...
  return (
    <center>
      <div className="searchpage-container">
        {/* ✅ pase handleSearch bay FindDoctorSearch */}
